import { stemmer } from "../libs/porter";

const tokenizing = (text) => {

    return text.split(' ') // ['ramesh1', '123', 'ramesh']
        .filter((word) => /[a-zA-Z]/.test(word)) // ['ramesh1', 'ramesh']
        .map((word) => {
...
const removeStopWords = (arr) => {
    ...
    return arr.filter((word) => {//remove \r\n
        return !STOP_WORDS.includes(word.replace(/(\r\n|\n|\r)/gm, ""));
    });
...
export { tokenizing, stemming, removeStopWords }